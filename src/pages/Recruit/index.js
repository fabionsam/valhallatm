...
class Recruit extends React.Component {
    constructor(props) {
        super(props);
        this.state = { nome: '', familia: '', atvmar: '', classe: '', pq: '', captcha: '', message: '', possuibarco: '', vetnov: '' };
        ...
        this.handleChangeNovato = this.handleChangeNovato.bind(this);
    }
    ...
    handleChangeNovato(event) {
        this.setState({ vetnov: event.target.value });
    }
    ...
    enviarEmail = async () => {
        ...
        const response = await api.post('/send', { nome: this.state.nome, familia: this.state.familia, atvmar: this.state.atvmar, possuibarco: this.state.possuibarco, classe: this.state.classe.value, pq: this.state.pq, vetnov: this.state.vetnov },
            {
    ...
    handleSubmit(event) {
        if (this.state.captcha === '' || this.state.classe === '' || this.state.nome === '' || this.state.possuibarco === '' ||
            this.state.familia === '' || this.state.atvmar === '' || this.state.pq === '' || this.state.vetnov === '')
            return;
        this.enviarEmail();
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body" id="contactform">
                                ...
                                <form style={this.state.message === "Por favor, aguarde..." ? { display: "none" } : {}}>
                                    ...
                                    <input type="text" name="vetnov" placeholder="NOVATO OU VETERANO?" value={this.state.vetnov} onChange={this.handleChangeNovato} required />
                                    <input type="text" name="possuibarco" placeholder="TEM INTERESSE NO CONTEÚDO PVP?" value={this.state.possuibarco} onChange={this.handleChangeBarco} required />
                                    <Select
