            ...
            <div className="container divHeightFooter">
                <div className="row align-items-center divHeightFooter">
                    <div className="col-auto divImgSobre">
                        ...
                        <a href="https://discord.gg/NBk4r5t" rel="noopener noreferrer" target="_blank"><img src={process.env.PUBLIC_URL+"/images/discord-preto.png"} width="35px" height="35px" alt="" style={{marginLeft: 15, marginRight: 15}}></img></a>
