                    ...
                    <div className="row justify-content-center" style={{ height: "100%" }}>
                        <div className="col-6" style={{ backgroundColor: "rgba(255, 255, 255, 0.5)", height: "100%", alignContent: "center" }}>
                            <div style={{ marginTop: "9.5%", marginLeft: "7%", marginRight: "27%" }}>
                                ...
                                <span style={{ fontSize: "15px", fontFamily: "cinzel-bold" }}>!!!PROIBIDO!!! ASSUNTOS RELACIONADOS A POLÍTICA/IDEOLOGIAS BEM COMO DESRESPEITO(RACISMO - HOMOFOBIA - TRANSFOBIA - MACHISMO - PEDOFILIA - VIOLÊNCIA - PRECONCEITO - GORE) DENTRO DO DISCORD OU NO JOGO.</span>
                            </div>
                        </div>
