            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarsDefault">
                    <ul class="navbar-custom navbar-nav ml-auto">
                        ...
                        <a class="nav-link" href="index.html">Recrutamento <span class="sr-only">(current)</span></a>
                        </li>
          ...
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <ul class="list-inline banner-social-buttons">
                ...
                <li class="d-inline">
                <a href="https://www.facebook.com/ValhallaTM/" class="btn btnghost btn-lg"><i class="fa fa-facebook fa-fw"></i> <span class="network-name">Facebook</span></a>
                </li>
